...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		...
		LT(2,KC_ESC), KC_BSPC, KC_SPC, LT(1,KC_ENT)
	),
        [_NUM] = LAYOUT_split_3x5_2(
		KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,
		KC_DEL, KC_CAPS, KC_PSCR, KC_INS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,
		TO(5), TO(6), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END,
		LT(3,KC_TAB), KC_TAB, TO(5), KC_NO
	),
		...
		KC_NO, KC_NO, KC_TAB, LT(3,KC_TAB)
	),
        [_COMBO] = LAYOUT_split_3x5_2(
		KC_F1, KC_F2, KC_F3, KC_F4, QK_BOOT, KC_VOLU, KC_MFFD, KC_NO, KC_NO, KC_NO,
		KC_F5, KC_F6, KC_F7, KC_F8, QK_BOOT, KC_MUTE, KC_MPLY, TO(4), KC_NO, KC_NO,
		...
		TO(0), TO(0), KC_PENT, KC_P0
	),
        [_FN] = LAYOUT_split_3x5_2(
		KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,
		KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19,
		KC_F20, KC_F21, KC_F22, KC_F23, KC_F24, KC_NO, KC_NO, KC_NO, KC_NO, KC_SLEP, KC_PWR,
		TO(0), TO(0), TO(0), TO(0)
	)
};
